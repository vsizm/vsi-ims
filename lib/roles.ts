...
export const permissions: Record<Role, string[]> = {
  ...
  EXECUTIVE_DIRECTOR:["organisation.read","approvals.final","reports.read","reports.approve","indicators.read","results.read","budgets.read","expenditure.read","finance.dashboard.read","volunteers.read","assignments.read"],
  PROGRAMME_MANAGER:["programmes.manage","projects.manage","activities.read","activities.manage","activities.approve","reports.read","reports.manage","reports.approve","indicators.read","indicators.manage","results.read","results.manage","geography.read","interventions.read","interventions.manage","beneficiaries.read","beneficiaries.write","budgets.read","expenditure.read","finance.dashboard.read","volunteers.read","assignments.read","assignments.manage"],
