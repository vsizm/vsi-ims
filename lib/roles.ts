...
export const permissions: Record<Role, string[]> = {
  SYSTEM_ADMINISTRATOR:["access.manage","audit.read","configuration.manage","directorates.manage","geography.read","budgets.manage","expenditure.manage","funding.manage"],
  ...
  FINANCE_OFFICER:["funding.manage","budgets.manage","expenditure.manage","budgets.read","expenditure.read","finance.dashboard.read"],
