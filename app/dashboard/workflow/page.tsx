    ...
    <main className="ims-shell">
      ...
      <section className="workspace">
        ...
        <div className="page-content workflow-page">
          <div className="title-bar"><div><p className="eyebrow">VSI FOUNDATION · V1 DELIVERY</p><h1>V1 governed workflow</h1><p>Programme → Project → Activity → Approval → Report.</p></div><Link className="primary-button" href="/dashboard">← Dashboard</Link></div>
