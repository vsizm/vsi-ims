      ...
      <section className="workspace">
        ...
        <div className="page-content">
          ...
          <div className="dashboard-grid">
            <section className="panel activity-panel" id="activities"><div className="panel-heading"><div><p className="eyebrow dark">OPERATIONS</p><h2>Recent activities</h2></div><Link href="/dashboard/workflow#activities">Manage →</Link></div><div className="activity-table">{activities.map((activity) => <article className="activity-row" key={activity.title}><div className={`activity-mark ${activity.tone}`}>{activity.title.slice(0, 1)}</div><div className="activity-main"><strong>{activity.title}</strong><span>{activity.programme}</span></div><span className={`status ${activity.tone}`}>{activity.status}</span><time>{activity.date}</time></article>)}</div></section>
            <section className="panel progress-panel" id="projects"><div className="panel-heading"><div><p className="eyebrow dark">PROJECT HEALTH</p><h2>Delivery progress</h2></div><span className="more">2026</span></div><div className="progress-visual"><div className="donut"><div><strong>67%</strong><span>on track</span></div></div><div className="progress-copy"><strong>Education & Youth Empowerment</strong><span>Project EYE-01</span><div className="bar"><i /></div><small>2 of 3 activity milestones planned or underway</small></div></div><div className="mini-metrics"><div><strong>1</strong><span>Project</span></div><div><strong>3</strong><span>Activities</span></div><div><strong>0</strong><span>Reports</span></div></div></section>
          </div>

          <div className="dashboard-grid lower-grid">
            <section className="panel notice-panel" id="reports"><div className="panel-heading"><div><p className="eyebrow dark">ATTENTION BOARD</p><h2>Next actions</h2></div><span className="count-badge">3</span></div><div className="notice-list"><div><span className="notice-dot gold-dot" /><p><strong>Submit activity</strong><small>School outreach planning is ready for submission.</small></p><b>Today</b></div><div><span className="notice-dot blue-dot" /><p><strong>Approval queue</strong><small>No activities currently awaiting approval.</small></p><b>Clear</b></div><div><span className="notice-dot navy-dot" /><p><strong>Quarterly report</strong><small>Reporting window closes 30 September 2026.</small></p><b>45d</b></div></div></section>
